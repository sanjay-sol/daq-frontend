  ...
  return (
    <>
      <section className="custom-scrollbar rightsidebar">
        <div className="w-80 max-w-sm p-4 bg-slate-800 overflow-x-hidden border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
          <h5 className="mb-3 text-base font-semibold text-gray-200 md:text-xl dark:text-white">
            Connect wallet
          </h5>
          <ul className="my-4 space-y-3">
            <li>
              <button className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-400 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                <svg
                  aria-hidden="true"
                  className="h-4"
                  viewBox="0 0 40 38"
          ...
          <div>
            ...
            {account ? (
              <p className="text-gray-200">{account}</p>
            ) : (
              <button
                onClick={connectWallet}
                className="mt-4 px-4 py-2 text-sm font-semibold text-white bg-violet-400 rounded-lg hover:bg-blue-600"
              >
                Connect Wallet
              </button>
            )}
        ...
        <div className="flex flex-1 flex-col justify-start">
          <h3 className="text-heading4-medium text-light-1">Recent Activity</h3>
          <div className="mt-7 flex w-[350px] flex-col gap-10">
            <div className="flex gap-4">
              <div className="w-12 h-12 bg-gray-300 rounded-full"></div>
              <div className="flex flex-col">
                <p className="text-heading5-medium text-light-1">John Doe</p>
                <p className="text-body2-regular text-light-1">Followed you</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="w-12 h-12 bg-gray-300 rounded-full"></div>
