...
const App = () => {
  const urlRepo = "https://github.com/sanjay-sol/nextjs-frontend-template";
  const urlTwitter = "https://twitter.com/SanjaySirangi";
  const urlLinkedIn = "https://www.linkedin.com/in/sanjay-sirangi/";
  const urlInsta = "https://linktr.ee/sanjaysirangi";
  return (
    <>
